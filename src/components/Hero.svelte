...
>
    <div class="flex flex-col lg:flex-row items-center w-full">
        <div
            class="text-container lg:w-1/2 flex flex-col items-center text-center"
        >
            <h1 class="hero text-5xl md:text-6xl font-bold">I'm McAuley</h1>
        ...
        <div
            class="image-container lg:w-1/2 flex justify-center lg:justify-end"
        >
            <img
